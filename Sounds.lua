...
SoundbookSounds = {
    ...
    ["Legacy"] = {
        ...
        { name = "Bad To The Bone",       icon = "Interface\\Icons\\INV_Misc_Bone_01",              tags = { "cool", "badass", "böse", "evil", "gitarre", "guitar", "musik" } },
        ...
        { name = "Kids Saying Yay",       icon = "Interface\\Icons\\Spell_Holy_PrayerOfHealing",   tags = { "kinder", "kids", "yay", "jubel", "cheer", "freude", "joy", "sieg", "win" } },
        ...
        { name = "More Dots",             icon = "Interface\\Icons\\Spell_Nature_FaerieFire",      tags = { "more dots", "wow", "raid", "onyxia", "dots", "schaden", "dps", "classic" } },
        ...
        { name = "Rock And Roll",         icon = "Interface\\Icons\\INV_Misc_Drum_01",             tags = { "rock", "roll", "musik", "gitarre", "guitar", "live", "concert" } },
        ...
        { name = "Super Mario Death",     icon = "Interface\\Icons\\Spell_Shadow_AnimateDead",     tags = { "mario", "nintendo", "tod", "death", "game over", "gestorben", "died" } },
