...
- right-click the idle icon for Quick Options (mute incoming, lock, muted players, open Soundbook); dragging its Announcer Size slider shows a live, full-opacity preview of the real Announcer layout (or resizes the real one in place if a sound is already playing) and returns to your saved opacity/size the instant you release it;
